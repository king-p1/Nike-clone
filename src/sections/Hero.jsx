...
const Hero = () => {
  ...
  return (
    <section
    id='home'
    className='  w-full mt-[0px] flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container '
  >
    ...
    xl:min-h-screen max-xl:py-40 ml-7 bg-cover bg-center '>
      <img
        src={bigShoeImg}
        alt='shoe colletion'
        width={510}
        height={402}
        className='object-contain relative  mb-8'
      />
